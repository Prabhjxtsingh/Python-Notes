...
if __name__ == "__main__":
    ...
    bg_image_path = r"C:\Users\ASUS\Downloads\Screenshot (19).png"  # Correct the file path
    form_image_path = r"C:\Users\ASUS\Desktop\LPU_X_Futurense_Logo.png"  # Provide the correct path to the form image
    root = tk.Tk()
    app = LoginApp(root, bg_image_path, form_image_path)
    root.mainloop()
